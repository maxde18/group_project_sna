...
Study 2 uses GERGM (Generalized Exponential Random Graph Model) to model network formation with covariates. For comparability between periods, we use the same set of parties (all parties from ideology data) but keep networks sparse (not fully connected). This allows: - Direct comparison of coefficients between periods - Proper alignment of edge covariates (co-sponsorship, coalition) - Consistent model interpretation
